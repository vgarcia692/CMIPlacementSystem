angular.module('cmiApp', ['ngRoute', 'ngResource', 'ui.bootstrap', 'ngTable'])

    .factory('PlacementExams', ['$resource', function($resource){
        return $resource('/placementTests/:id', {id:'@id'}, {
            'update': { method:'PUT' }
        });
    }])

    .controller('mainController', ['$scope', 'PlacementExams', '$filter', 'ngTableParams', function ($scope, PlacementExams, $filter, ngTableParams) {

        PlacementExams.query().$promise.then(function(data) {
            ...
            $scope.tableParams = new ngTableParams({
                ...
                getData: function($defer, params) {
                    ...
                    $scope.exams = orderedData.slice((params.page() - 1 ) * params.count(), params.page() * params.count());

                    params.total(orderedData.length);
                    $defer.resolve($scope.exams);
                }
            });
    ...
    .config(['$routeProvider', function ($routeProvider) {
        $routeProvider
            ...
            .when('/placementTests', {
                templateUrl: './views/placementTest.html',
                controller: 'mainController'
            })


            .when('/placementTests/:id', {
                templateUrl: './views/placementTestDetails.html',
